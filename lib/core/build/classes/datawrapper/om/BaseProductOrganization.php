...
/**
 * Base class that represents a row from the 'product_organization' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseProductOrganization extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProductOrganizationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProductOrganizationPeer
     */
     ...
     */
    public function getExpiresAt($format = '%x')
    {
        if ($this->expires_at === null) {
            return null;
        }

        if ($this->expires_at === '0000-00-00') {
     ...
     * @return ProductOrganization The current object (for fluent API support)
     */
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = ProductOrganizationPeer::PRODUCT_ID;
        }
    ...
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = ProductOrganizationPeer::ORGANIZATION_ID;
        }
    ...
    public function setExpiresAt($v)
    {
        ...
        if ($this->expires_at !== null || $dt !== null) {
            $currentDateAsString = ($this->expires_at !== null && $tmpDt = new DateTime($this->expires_at)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->expires_at = $newDateAsString;
                $this->modifiedColumns[] = ProductOrganizationPeer::EXPIRES_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProductOrganizationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProductOrganization object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProductOrganizationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProductOrganizationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductOrganizationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductOrganizationPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(ProductOrganizationPeer::ORGANIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`organization_id`';
        }
        if ($this->isColumnModified(ProductOrganizationPeer::EXPIRES_AT)) {
            $modifiedColumns[':p' . $index++]  = '`expires_at`';
        }

        $sql = sprintf(
            'INSERT INTO `product_organization` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProductOrganizationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProductOrganizationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProductOrganization'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductOrganization'][serialize($this->getPrimaryKey())] = true;
        $keys = ProductOrganizationPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductOrganizationPeer::PRODUCT_ID)) $criteria->add(ProductOrganizationPeer::PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(ProductOrganizationPeer::ORGANIZATION_ID)) $criteria->add(ProductOrganizationPeer::ORGANIZATION_ID, $this->organization_id);
        if ($this->isColumnModified(ProductOrganizationPeer::EXPIRES_AT)) $criteria->add(ProductOrganizationPeer::EXPIRES_AT, $this->expires_at);
    ...
    {
        $criteria = new Criteria(ProductOrganizationPeer::DATABASE_NAME);
        $criteria->add(ProductOrganizationPeer::PRODUCT_ID, $this->product_id);
        $criteria->add(ProductOrganizationPeer::ORGANIZATION_ID, $this->organization_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getProductId()) && (null === $this->getOrganizationId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProductOrganization (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProductOrganization Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProductOrganizationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProductOrganizationPeer();
        }
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && (($this->product_id !== "" && $this->product_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProduct->addProductOrganizations($this);
             */
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && ($this->organization_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrganization->addProductOrganizations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductOrganizationPeer::DEFAULT_STRING_FORMAT);
    }
